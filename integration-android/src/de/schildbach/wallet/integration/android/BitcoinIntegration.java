...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("bitrevshares:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No BitRevShares application found.\nPlease install BitRevShares Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.bitrevshares.wallet"));
